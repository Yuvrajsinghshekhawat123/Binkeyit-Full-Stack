...
export function CardProductList({ products }) {
  ...
  return (
    <>
      <div
        className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2  lg:grid-cols-3 xl:grid-cols-4 place-items-center  space-y-4 w-full bg-white"
        ...
        {products.map((product, i) => {
          ...
          return (
            <div
              ...
              key={product.id || i}
              className="relative w-[50vw] h-[45vh]  md:w-[25vw] md:h-[50vh] lg:w-[20vw]  lg:h-auto xl:w-[17vw]  2xl:w-[14vw] xl:h-auto  flex-shrink-0 font-normal space-y-2 border p-4 shadow-lg border-gray-200 rounded-xl flex flex-col justify-between cursor-pointer"
            >
              {/* Discount Badge */}
              {discount > 0 && (
